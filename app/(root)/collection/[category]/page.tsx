			...
			<div className="container mx-auto  ">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 p-6 ">
					{categorymain.map((product: any) => (
						<div
							key={product._id}
							className="mx-auto mt-4 w-full max-w-[300px] rounded-2xl overflow-hidden  hover:translate-y-[-8px] transition-all duration-300 flex flex-col h-full group border ">
							...
							<div className="relative aspect-square w-full h-4/5 overflow-hidden">
								...
								<div className="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
									<Link
										...
										className="absolute bottom-4 left-1/2 -translate-x-1/2 transform-gpu translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
										<Button
											variant="secondary"
											size="lg"
											className="rounded-full   shadow-xl transform-gpu hover:scale-102 transition-transform duration-200">
